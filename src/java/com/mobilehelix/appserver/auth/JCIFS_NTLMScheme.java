 ...
 *
 * @author Sachin M (with updates by Seth Hallem)
 *
 */
public class JCIFS_NTLMScheme implements AuthScheme {

    private static final Logger LOG = Logger.getLogger(JCIFS_NTLMScheme.class.getName());
    /**
    ...
    private class NTLM {
        ...
        private String generateType3Msg(String username, String password, String host,
            ...
            Type3Message t3m = 
                    new Type3Message(t2m, password, domain, username, host, 0);
