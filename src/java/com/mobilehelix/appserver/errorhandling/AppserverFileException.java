 ...
 * @author shallem
 */
public class AppserverFileException extends Exception {
    ...
    private static void init() {
        resources = ResourceBundle.getBundle("com.mobilehelix.appserver.resources/FileErrorMessages");
    }
    
    public AppserverFileException(Exception e, String s, String key) {
        super(s);
        this.initLists(1);
        this.initCause(e);
    ...
    public AppserverFileException(Exception e, String s, String key, Object[] args) {
        super(s);
        this.initCause(e);
        this.initLists(1);
        this.msgResourceKeys.add(key);
    ...
    public AppserverFileException(String s, String key) {
        super(s);
        this.initLists(1);
        this.msgResourceKeys.add(key);
        this.msgResourceArgs.add(null);
    ...
    public AppserverFileException(String s, String key, Object[] args) {
        super(s);
        this.initLists(1);
        this.msgResourceKeys.add(key);
        this.msgResourceArgs.add(args);
    ...
    public AppserverFileException(String s, List<String> keys, List<Object[]> args) {
        super(s);
