 ...
 * @author shallem
 */
public class AppserverSPException extends Exception {
    ...
    private static void init() {
        resources = ResourceBundle.getBundle("com.mobilehelix.appserver.resources/SharepointErrors");
    }
    
    public AppserverSPException(Exception e, String s, String key) {
        super(s);
        this.initLists(1);
        this.initCause(e);
    ...
    public AppserverSPException(Exception e, String s, String key, Object[] args) {
        super(s);
        this.initCause(e);
        this.initLists(1);
        this.msgResourceKeys.add(key);
    ...
    public AppserverSPException(String s, String key) {
        super(s);
        this.initLists(1);
        this.msgResourceKeys.add(key);
        this.msgResourceArgs.add(null);
    ...
    public AppserverSPException(String s, String key, Object[] args) {
        super(s);
        this.initLists(1);
        this.msgResourceKeys.add(key);
        this.msgResourceArgs.add(args);
    ...
    public AppserverSPException(String s, List<String> keys, List<Object[]> args) {
        super(s);
